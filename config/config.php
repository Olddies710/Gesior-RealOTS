...
$config['site']['serverPath'] = "/home/ubuntu/realotsloginserver/";
$config['site']['serverName'] = 'RL OTS';
$config['site']['mysqlHost'] = 'localhost';
$config['site']['mysqlPort'] = '3306';
$config['site']['mysqlUser'] = 'otsmanager';
$config['site']['mysqlPass'] = 'otsmanager';
$config['site']['mysqlDatabase'] = 'otsmanager';
...
$config['site']['max_players_per_account'] = 4; // in RL OTS it's limited to 1 in database
